...
from graphgps.layer.gatedgcn_layer_noedge import GatedGCNLayer as GatedGCNLayer_noedge
...
class CustomGNN(torch.nn.Module):
    """
    GNN model that customizes the torch_geometric_utils.graphgym.models.gnn.GNN
    to support specific handling of new conv layers.

    no influence from gnn.stage_type of graphgym.model.gnn, therefore no post layer in CustomGNN_+
    """
