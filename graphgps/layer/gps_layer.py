...
from graphgps.layer.gatedgcn_layer_noedge import GatedGCNLayer as GatedGCNLayerNoEdge
...
class GPSLayer(nn.Module):
    ...
    def __init__(self, dim_h,
        ...
        elif local_gnn_type == 'CustomGatedGCN_NoEdge':
            self.local_model = GatedGCNLayerNoEdge(dim_h, dim_h,
                                             dropout=dropout,
                                             residual=True,
                                             equivstable_pe=equivstable_pe)
        else:
    ...
    def forward(self, batch):
        ...
        if self.local_model is not None:
            ...
            elif self.local_gnn_type == 'CustomGatedGCN_NoEdge':
                es_data = None
                if self.equivstable_pe:
                    es_data = batch.pe_EquivStableLapPE
                local_out = self.local_model(Batch(batch=batch,
