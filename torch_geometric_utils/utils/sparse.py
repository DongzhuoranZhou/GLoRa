...
# from torch_geometric_utils.utils import coalesce, cumsum
from torch_geometric.utils import coalesce
from torch_geometric_utils.utils.functions import cumsum
...
def to_torch_coo_tensor(
    ...
    `torch.sparse_coo`.
    See :meth:`~torch_geometric_utils.utils.to_edge_index` for the reverse operation.
